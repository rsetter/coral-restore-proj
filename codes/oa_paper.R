...
oa <- raster("E:/oa/empirical/OAempiricalf.tif")
...
dfext <- as.data.frame(reefext)
  ...
  dfi <- subset(dfext,select=c("pointid","grid_code","iscoral","ID","oa_OAempiricalf"))
  ...
  write.csv(dfi,"emp_2005_suit.csv", row.names=FALSE)
